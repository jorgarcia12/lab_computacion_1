...
public class ejercicio_2 {
    public static void main(String[] args) {
        ...
        System.out.println(multiplicacionArrays(matriz_a,matriz_b,matriz_c, f, c));
    ...
    private static int[][] multiplicacionArrays(int[][] matrizA, int[][] matrizB, int[][] matrizC, int filas, int columnas) {
